...
public class GoblinWarriorEntityAnimation {
    public static final AnimationDefinition GOBLINWARRIOR_IDLE = AnimationDefinition.Builder.withLength(6f).looping()
            .addAnimation("h_head",
    ...
    public static final AnimationDefinition GOBLINWARRIOR_DEATH = AnimationDefinition.Builder.withLength(0.7916766f).looping()
            .addAnimation("Goblin",
            ...
            .addAnimation("RightArm",
                    new AnimationChannel(AnimationChannel.Targets.ROTATION,
                            ...
                            new Keyframe(0.5f, KeyframeAnimations.degreeVec(20f, -1.71f, 4.7f),
                                    AnimationChannel.Interpolations.LINEAR))).build();
    public static final AnimationDefinition GOBLINWARRIOR_WALK = AnimationDefinition.Builder.withLength(0.7083434f).looping()
            .addAnimation("Goblin",
                    new AnimationChannel(AnimationChannel.Targets.POSITION,
                            new Keyframe(0f, KeyframeAnimations.posVec(0f, 0f, 0f),
                                    AnimationChannel.Interpolations.LINEAR),
