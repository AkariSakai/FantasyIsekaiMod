...
public class GoblinEntityAnimation {
    public static final AnimationDefinition GOBLIN_IDLE = AnimationDefinition.Builder.withLength(6f).looping()
            .addAnimation("h_head",
    ...
    public static final AnimationDefinition GOBLIN_DEATH = AnimationDefinition.Builder.withLength(0.7916766f).looping()
            .addAnimation("Body",
            ...
            .addAnimation("RightArm",
                    new AnimationChannel(AnimationChannel.Targets.ROTATION,
                            ...
                            new Keyframe(0.5f, KeyframeAnimations.degreeVec(20f, -1.71f, 4.7f),
                                    AnimationChannel.Interpolations.LINEAR))).build();
    public static final AnimationDefinition GOBLIN_WALK = AnimationDefinition.Builder.withLength(0.6766666f).looping()
            .addAnimation("Body",
                    new AnimationChannel(AnimationChannel.Targets.POSITION,
                            new Keyframe(0f, KeyframeAnimations.posVec(0f, 0f, 0f),
                                    AnimationChannel.Interpolations.LINEAR),
            ...
            .addAnimation("RightArm",
                    new AnimationChannel(AnimationChannel.Targets.ROTATION,
                            ...
                            new Keyframe(0.6766666f, KeyframeAnimations.degreeVec(0f, 0f, 0f),
                                    AnimationChannel.Interpolations.LINEAR))).build();
    public static final AnimationDefinition GOBLIN_ATTACK = AnimationDefinition.Builder.withLength(0.7916766f)
            .addAnimation("LeftArm",
                    new AnimationChannel(AnimationChannel.Targets.ROTATION,
                            new Keyframe(0.25f, KeyframeAnimations.degreeVec(0f, 0f, 0f),
                                    AnimationChannel.Interpolations.LINEAR),
                            new Keyframe(0.2916767f, KeyframeAnimations.degreeVec(-24.89f, -9.89f, -20.31f),
                                    AnimationChannel.Interpolations.LINEAR),
            ...
            .addAnimation("RightArm",
                    new AnimationChannel(AnimationChannel.Targets.ROTATION,
                            new Keyframe(0f, KeyframeAnimations.degreeVec(0f, 0f, 0f),
                                    AnimationChannel.Interpolations.LINEAR),
                            new Keyframe(0.041676664f, KeyframeAnimations.degreeVec(-24.89f, -9.89f, -20.31f),
                                    AnimationChannel.Interpolations.LINEAR),
