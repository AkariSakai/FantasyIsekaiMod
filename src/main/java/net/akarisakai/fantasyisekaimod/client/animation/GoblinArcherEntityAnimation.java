...
public class GoblinArcherEntityAnimation {
    public static final AnimationDefinition GOBLINARCHER_IDLE = AnimationDefinition.Builder.withLength(6f).looping()
            .addAnimation("h_head",
    ...
    public static final AnimationDefinition GOBLINARCHER_DEATH = AnimationDefinition.Builder.withLength(0.7916766f).looping()
            .addAnimation("Body",
            ...
            .addAnimation("RightArm",
                    new AnimationChannel(AnimationChannel.Targets.ROTATION,
                            ...
                            new Keyframe(0.5f, KeyframeAnimations.degreeVec(20f, -1.71f, 4.7f),
                                    AnimationChannel.Interpolations.LINEAR))).build();
    public static final AnimationDefinition GOBLINARCHER_WALK = AnimationDefinition.Builder.withLength(0.6766666f).looping()
            .addAnimation("Body",
                    new AnimationChannel(AnimationChannel.Targets.POSITION,
                            new Keyframe(0f, KeyframeAnimations.posVec(0f, 0f, 0f),
                                    AnimationChannel.Interpolations.LINEAR),
